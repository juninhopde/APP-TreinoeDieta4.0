...
const IA_PROVEDORES = {
  ...
  anthropic: {
    ...
    modelos: ['claude-haiku-4-5-20251001', 'claude-sonnet-4-6', 'claude-sonnet-5'],
...
function erroIA(status, corpo, prov) {
  ...
  if (status === 404) return new Error('Modelo não encontrado. Seleciona "gemini-1.5-flash" na lista e testa novamente.');
